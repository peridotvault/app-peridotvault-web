...
export const ModalProfile = ({ onClose, accountId }: Props) => {
  ...
  return (
    <div
      className="bg-card rounded-2xl px-4 py-6 w-full flex flex-col gap-4 items-center border border-foreground/10 shrink-0"
      role="dialog"
